  ...
  <ParameterList name="PKs" type="ParameterList">
    ...
    <ParameterList name="subsurface flow" type="ParameterList">
      ...
      <ParameterList name="initial condition" type="ParameterList">
        <Parameter name="restart file" type="string" value="/bigwork/nhgjrabl/Simulations/pestpp/rk_model_final_4yrs_su/Spinup_final_16032022/Case5_I_E_cv_spinup_III_HD1.demo/checkpoint_final.h5" />
      </ParameterList>
          ...
          <ParameterList name="domain" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="/bigwork/nhgjrabl/Simulations/ats-demos/rk_model/Data/Data_Yakou/Yakou_met_data_ITP_rk/Final_InputData_4yrs/Calib_data_2016_2018.h55" />
