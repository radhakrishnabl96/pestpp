#!/bin/bash -l
#SBATCH --job-name=pest_case5_III_rw
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
singularity exec /bigwork/nhgjrabl/Singularity/ats_pest_final_2.sif pestpp-glm Case5_III_su_cv_cf_v1_rw.pst &>pest_out.log