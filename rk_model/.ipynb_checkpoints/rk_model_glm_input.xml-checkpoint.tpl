...
<ParameterList name="Main" type="ParameterList">
  <ParameterList name="mesh" type="ParameterList">
    <ParameterList name="domain" type="ParameterList">
      ...
      <ParameterList name="read mesh file parameters" type="ParameterList">
        <Parameter name="file" type="string" value="../../../Data/data_mesh/test_org_spinup_column.exo" />
  ...
  <ParameterList name="regions" type="ParameterList">
    ...
    <!-- Considering surface at {0.0, 0.0, 0.0} and moving downwards, therefore negative. Assuming that the first sensor is 1 cm below the surface and so on .. -->
    ...
    <ParameterList name="subsurface point -0.04" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-0.04}" />
      </ParameterList>
    </ParameterList>
    ...
    <ParameterList name="subsurface point -0.2" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-0.2}" />
      </ParameterList>
    </ParameterList>
    ...
    <ParameterList name="subsurface point -0.8" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-0.8}" />
      </ParameterList>
    </ParameterList>
    <ParameterList name="subsurface point -1.2" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-1.2}" />
      </ParameterList>
    </ParameterList>
    <ParameterList name="subsurface point -1.6" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-1.6}" />
      </ParameterList>
    </ParameterList>
    <ParameterList name="subsurface point -5.0" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-5.0}" />
      </ParameterList>
    </ParameterList>
    ...
    <ParameterList name="subsurface point -40.0" type="ParameterList">
      <ParameterList name="region: point" type="ParameterList">
        <Parameter name="coordinate" type="Array(double)" value="{0.0,0.0,-40.0}" />
      </ParameterList>
    </ParameterList>
  </ParameterList>
      ...
      <ParameterList name="water retention evaluator" type="ParameterList">
        ...
        <ParameterList name="WRM parameters" type="ParameterList">
          <ParameterList name="peat" type="ParameterList">
            ...
            <Parameter name="van Genuchten alpha [Pa^-1]" type="double" value="#af_p         #" />
            <Parameter name="van Genuchten n [-]" type="double" value="1.4" />
          ...
          <ParameterList name="mineral" type="ParameterList">
            ...
            <Parameter name="WRM Type" type="string" value="van Genuchten" />
            <Parameter name="van Genuchten alpha [Pa^-1]" type="double" value="#af_m         #" />
          ...
          <ParameterList name="Top" type="ParameterList">
            ...
            <ParameterList name="boundary temperature" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                ...
                <Parameter name="file" type="string" value="../../Data/Yakou_data_2017.h5" />
    ...
    <ParameterList name="field evaluators" type="ParameterList">
      ...
      <ParameterList name="capillary_pressure_liq_ice" type="ParameterList">
        ...
        <ParameterList name="capillary pressure of ice-water" type="ParameterList">
          ...
          <Parameter name="latent heat [J kg^-1]" type="double" value="334000" />
        </ParameterList>
        <ParameterList name="verbose object" type="ParameterList">
          <Parameter name="verbosity level" type="string" value="low" />
        </ParameterList>
      ...
      <ParameterList name="internal_energy_liquid" type="ParameterList">
        ...
        <ParameterList name="IEM parameters" type="ParameterList">
          ...
          <Parameter name="heat capacity [J mol^-1 K^-1]" type="double" value="76" />
        </ParameterList>
        <ParameterList name="verbose object" type="ParameterList">
          <Parameter name="verbosity level" type="string" value="low" />
        </ParameterList>
      ...
      <ParameterList name="internal_energy_rock" type="ParameterList">
        ...
        <ParameterList name="IEM parameters" type="ParameterList">
          <Parameter name="IEM type" type="string" value="linear" />
          <Parameter name="heat capacity [J kg^-1 K^-1]" type="double" value="620" />
        </ParameterList>
        <ParameterList name="verbose object" type="ParameterList">
          <Parameter name="verbosity level" type="string" value="low" />
        </ParameterList>
      ...
      <ParameterList name="base_porosity" type="ParameterList">
        ...
        <ParameterList name="function" type="ParameterList">
          <ParameterList name="peat" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="0.50" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
          <ParameterList name="mineral" type="ParameterList">
      ...
      <ParameterList name="density_rock" type="ParameterList">
        ...
        <ParameterList name="function" type="ParameterList">
          ...
          <ParameterList name="mineral" type="ParameterList">
            ...
            <ParameterList name="function" type="ParameterList">
              <ParameterList name="function-constant" type="ParameterList">
                <Parameter name="value" type="double" value="1900" />
              </ParameterList>
            </ParameterList>
          </ParameterList>
          <ParameterList name="bedrock" type="ParameterList">
  ...
  <ParameterList name="observations" type="ParameterList">
    <ParameterList name="observation file" type="ParameterList">
      ...
      <Parameter name="observation output filename" type="string" value="rk_model_glm_obs_data.dat" />
